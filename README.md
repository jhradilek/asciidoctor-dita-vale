...
| CalloutList | DITA 1.3 does not support [callouts](https://docs.asciidoctor.org/asciidoc/latest/verbatim/callouts/). Rewrite your content to avoid the need for callouts or use [a description list](https://docs.asciidoctor.org/asciidoc/latest/lists/description/). |
